...
public class EdmsTestContainer extends TestContainer {

    public EdmsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/estartsev/edms/app.properties",
    ...
    public static class Common extends EdmsTestContainer {

        public static final EdmsTestContainer.Common INSTANCE = new EdmsTestContainer.Common();
